...
export default function CalendarEdit({ params }) {
    ...
    const [modeInfo, setModeInfo] = useState({ mode: params.mode });
    ...
    const [boardAttachFiles, setBoardAttachFiles] = useState(null);

    const [schdulBgndeHH, setSchdulBgndeHH] = useState(null);
    ...
    const retrieveDetail = () => {
        ...
        ExtApi.fetchPostById("CALENDAR", params.id)
            .then((response) => {
        ...
        <div className="container">
            <div className="c_wrap">
                ...
                <div className="location">
                    <ul>
                        {/*<li><Link href={URL.MAIN} className="home">Home</Link></li>*/}
                        {/*<li><Link href={URL.ADMIN}>사이트관리</Link></li>*/}
                        {/*<li>일정관리</li>*/}
                    </ul>
                </div>
                {/* <!--// Location --> */}
                        ...
                        <div className="board_view2">
                                ...
                                <dd>
                                    <label className="f_select w_130" htmlFor="schdulSe">
                                        <select id="schdulSe" name="schdulSe" title="일정구분"
                                            ...
                                            <option value="1">법회</option>
                                            <option value="2">기도</option>
                            ...
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link href={URL.NEWS_CALENDAR} className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
